...
var REIMPORT_ALL_SOURCES = require("./jobs/REIMPORT_ALL_SOURCES")
...
async function start() {
    ...
    agenda.start();
    // Schedule to reimport all sources every day at midnight
    // If there already is a daily reimport job in the db, this will not create another one
    agenda.every("0 0 * * *", REIMPORT_ALL_SOURCES);
    // also execute it right now
    agenda.now(REIMPORT_ALL_SOURCES);
    /**
